...
QT_MOC_LITERAL(1, 15, 13), // "requestToSend"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 3), // "req"
QT_MOC_LITERAL(4, 34, 18) // "register_2_clicked"

    },
    "registerwindow\0requestToSend\0\0req\0"
    "register_2_clicked"
};
...
void registerwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->register_2_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (registerwindow::*_t)(void * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&registerwindow::requestToSend)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void registerwindow::requestToSend(void * _t1)
{
