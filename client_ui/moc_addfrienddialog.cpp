...
QT_MOC_LITERAL(1, 16, 13), // "requestToSend"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 3), // "req"
QT_MOC_LITERAL(4, 35, 17) // "sendFriendRequest"

    },
    "AddFriendDialog\0requestToSend\0\0req\0"
    "sendFriendRequest"
};
...
void AddFriendDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendFriendRequest(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (AddFriendDialog::*_t)(void * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddFriendDialog::requestToSend)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AddFriendDialog::requestToSend(void * _t1)
{
